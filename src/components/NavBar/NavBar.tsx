...
import NavBarItem from "./NavBarItem";
import { FaUser, FaHome, FaCamera, FaMusic, FaBookmark} from "react-icons/fa";
    ...
    <div className="MainPage">
      <aside className="LeftSide">
        <nav className="Navbar">
          ...
          <NavBarItem
            icon={<FaHome  color="blue" size={25} />}
            itemText="Главная"
            navigatePath="/main"
          />
          <NavBarItem
            icon={<FaUser color="blue" size={25} />}
            itemText="Профиль"
            navigatePath="/profile"
          />
          <NavBarItem
            icon={<FaCamera color="blue" size={25} />}
            itemText="Фотографии"
            navigatePath="#"
          />
          <NavBarItem
            icon={<FaMusic color="blue" size={25} />}
            itemText="Музыка"
            navigatePath="#"
          />
          <NavBarItem
            icon={<FaBookmark color="blue" size={25} />}
